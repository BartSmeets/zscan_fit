...
# In repository
import zscan.optimize.basinhopping
...
def run(measurement: np.dtype, fit_type: int, n_runs: int, p0: list, model_param: list, experiment_param: list, root, iter_label, value_label, age_label, pb):
    ...
    if fit_type == 0:
        ...
        for i in range(n_runs):
            ...
            popt, chi2 = zscan.optimize.basinhopping.OPA(measurement, p0, L, ALPHA0, I0, Z_R, model_param, age_label, iter_label, root)
    ...
    # Run 2PA no Is2
        ...
        for i in range(n_runs):
            ...
            popt, chi2 = zscan.optimize.basinhopping.TPA_no_Is2(measurement, p0, L, ALPHA0, I0, Z_R, model_param, age_label, iter_label, root)    # Run model
            ## Store results
            RUNS[i, 0]=popt[0]
            RUNS[i, 1]=popt[1]
            RUNS[i, 2]=popt[2]
    ...
    # Run 2PA
        ...
        for i in range(n_runs):
            ...
            popt, chi2 = zscan.optimize.basinhopping.TPA(measurement, p0, L, ALPHA0, I0, Z_R, model_param, age_label, iter_label, root)    # Run model
            ## Store results
            RUNS[i, 0]=popt[0]
            RUNS[i, 1]=popt[1]
            RUNS[i, 2]=popt[2]
    ...
    # Run 2PA no Is1
        ...
        for i in range(n_runs):
            ...
            popt, chi2 = zscan.optimize.basinhopping.TPA_no_Is1(measurement, p0, L, ALPHA0, I0, Z_R, model_param, age_label, iter_label, root)    # Run model
            ## Store results
            RUNS[i, 0]=popt[0]
            RUNS[i, 1]=popt[1]
            RUNS[i, 2]=popt[2]
    ...
    # Run 2PA no sat
        ...
        for i in range(n_runs):
            ...
            popt, chi2 = zscan.optimize.basinhopping.TPA_no_sat(measurement, p0, L, ALPHA0, I0, Z_R, model_param, age_label, iter_label, root)    # Run model
            ## Store results
            RUNS[i, 0]=popt[0]
            RUNS[i, 1]=popt[1]
            RUNS[i,2] = chi2
